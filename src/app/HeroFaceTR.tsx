...
export default function HeroFaceTR() {
  ...
  useEffect(() => {
    ...
    let animId: number;
    const animate = () => {
      const leftTarget = getTarget('tr-left-eye-container');
      const rightTarget = getTarget('tr-right-eye-container');
  ...
  return (
    <div
      className="hero-face hero-face-tr"
      aria-hidden="true"
      ref={faceRef}
    ...
    >
      ...
      <img
        key={gifKey}
        ref={gifRef}
        src="/facesgifs/TopRightFace.webp"
        alt=""
